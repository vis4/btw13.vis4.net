...
(function() {
  ...
  $(function() {
    var cityLabels, keys, lastKey, map_cont, mode, partyCols, rename, selected, thumb_cont, year, years, _cs, _key, _sg;
    map_cont = $('#map');
        ...
        return $.get('/assets/svg/wk17-small-alt.svg', function(svg2) {
          ...
          getVote = function(wk, key) {
            if ((wk.v2[key] != null) && (wk.v2[key][year] != null)) {
              return wk.v2[key][year] / wk.v2.total[year];
            } else {
              return null;
            }
          };
          ...
          updateMaps = function(key) {
            _key = lastKey = key;
            _cs = getColorScale();
            $('h1.key').html(rename[key] != null ? rename[key] : key);
            ...
            if (mode === 'choropleth') {
              ...
              _sg = main.addSymbols({
                ...
                radius: function(d) {
                  return Math.sqrt(data[d.id].p / 100000) * 20;
                },
                tooltip: function(d) {
                  return d.id;
                }
          ...
          initMaps = function() {
            ...
            $.each(keys, function(i, key) {
              ...
              t.append('<label>' + (rename[key] != null ? rename[key] : key) + '</label>');
              t.css('opacity', 0);
              setTimeout(function() {
                return t.animate({
                  opacity: 1
