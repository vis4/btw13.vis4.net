...
$(function() {
    ...
    function render(all, sortBy) {
        ...
        var d = $('<div class="win">Direktmandate<br/></div>').appendTo(head);
        ...
        d = $('<div class="win2 win">Landtagswahl 2008<br/></div>').appendTo(head);
