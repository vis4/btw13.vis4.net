...
$(function() {
    ...
    function render(all, sortBy) {
        ...
        var d = $('<div class="win2 win">Election 2003<br/></div>').appendTo(head);
        ...
        d = $('<div class="win">Direct mandates<br/></div>').appendTo(head);
        ...
        //$('<div class="est">Population</div>').data('sort-by', 'p').appendTo(head);
