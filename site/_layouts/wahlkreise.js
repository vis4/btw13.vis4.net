...
$(function() {
    ...
    function render(all, sortBy) {
        ...
        var d = $('<div class="win2 win">{{ "Zweitstimmen bei Landtagswahl 2008 (%)" | t: "Election 2003" }}<br/></div>').appendTo(head);
        ...
        d = $('<div class="win2 win">{{ "Zweitstimmen bei Landtagswahl 2013 (%)" | t: "Election 2008" }}<br/></div>').appendTo(head);
        $('<div>CDU</div>').data('sort-by', 'v2-CDU').appendTo(d);
        $('<div>SPD</div>').data('sort-by', 'v2-SPD').appendTo(d);
        $('<div>FDP</div>').data('sort-by', 'v2-FDP').appendTo(d);
        $('<div>GRÜ</div>').data('sort-by', 'v2-GRU').appendTo(d);
        ...
        d = $('<div class="win">{{ "Gewinner des Direktmandats" | t: "Direct mandates" }}<br/></div>').appendTo(head);
        ...
        $('<div class="est">{{ "Sozialvers. Beschäftigte (%)" | t: "Employed" }}</div>')
